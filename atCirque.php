...
<section class=" contenu">
    <article class="uk-article">
        ...
        <h2>La technique</h2>
        <p>
            Les apprentissages passent par des phases :<br/>
        <ul>
            <li>d'observation où les enfants essaient de comprendre, reproduire un mouvement,</li>
            <li>d'explorations où les enfants vont chercher, tester et créer avec leur propre corps.</li>
        </ul>
        <br/>
        Nous nous déplaçons dans votre école avec tout le matériel
        spécifique à la pratique des Arts du Cirque. <br/>
        <ul>
        ...
        Le choix des techniques abordées se fait en fonction de l'âge des élèves et de la durée du projet.
        </p>

        <h2>Les projets et interventions </h2>
        <p>
            Nous intervenons dans différentes structures (écoles, centres sociaux, centres de loisirs, crèches…)<br/>
        ...
        Et bien d'autres encore en fonction des envies des enseignants.
        </p>
