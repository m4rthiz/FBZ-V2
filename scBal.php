...
<section class=" contenu">
    <article class="uk-article">
        ...
        <p class="uk-text-lead">Pour vous faire valser, sauter, tourner...
        </p>

        <div class="uk-card uk-card-default uk-card-body ">
            <h2>Un duo</h2>
            <img src="img/logo-salkantai.png" align=left alt="photo" width="200" class="image">
            <br/>
            <p>L'accordéon, la flûte et la contrebasse qui s'accordent pour vous interpréter des compositions mais aussi
                des reprises du répertoire traditionnel.
                <br/>
